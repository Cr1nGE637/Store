...
public static class DemoDataExtensions
{
    ...
    [
        new() { CategoryId = DemoIds.Smartphones, CategoryName = "Smartphones" },
        new() { CategoryId = DemoIds.Laptops, CategoryName = "Laptops" },
        new() { CategoryId = DemoIds.Storage, CategoryName = "Storage" },
        new() { CategoryId = DemoIds.GraphicsCards, CategoryName = "Graphics Cards" },
        new() { CategoryId = DemoIds.Monitors, CategoryName = "Monitors" },
        new() { CategoryId = DemoIds.Peripherals, CategoryName = "Peripherals" },
        new() { CategoryId = DemoIds.Accessories, CategoryName = "Accessories" }
    ];
