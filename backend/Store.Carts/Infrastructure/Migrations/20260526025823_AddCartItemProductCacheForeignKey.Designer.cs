...
namespace Store.Carts.Infrastructure.Migrations
{
    ...
    [Migration("20260526025823_AddCartItemProductCacheForeignKey")]
    partial class AddCartItemProductCacheForeignKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Store.Carts.Infrastructure.Entity.CartItemEntity", b =>
                {
                    ...
                    b.HasOne("Store.Carts.Infrastructure.Entity.ProductCacheEntity", "Product")
                        .WithMany("CartItems")
